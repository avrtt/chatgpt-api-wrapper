...
import openai
from chatgpt_api_wrapper.config import settings
from chatgpt_api_wrapper.chatgpt.schema import (
    BaseMessage,
    UserMessage,
    SystemMessage,
)
...
if TYPE_CHECKING:
    from chatgpt_api_wrapper.chatgpt.response import AssistantResponse
...
class ChatSession(BaseModel):
    ...
    async def generate(self, **kwargs) -> "AssistantResponse":
        ...
        from chatgpt_api_wrapper.chatgpt.response import AssistantResponse  # workaround for circular import 
